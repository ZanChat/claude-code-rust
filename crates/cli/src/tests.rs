use super::{
    ...
    pane_from_shortcut_for_terminal, pending_interrupt_messages, prompt_file_picker_choice_list,
    prompt_history_from_messages, prompt_history_search_matches, prompt_selection_text,
    render_auth_command_with_resume, render_ide_command_with_home, render_remote_control_command,
