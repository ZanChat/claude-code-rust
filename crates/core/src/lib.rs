...
pub fn compatibility_command_registry() -> CommandRegistry {
    ...
    for spec in [
        ...
        builtin_command(
            "theme",
            "Inspect or save the preferred terminal theme preset.",
            CommandCategory::Config,
            CommandKind::Local,
            &[],
            false,
        ...
        builtin_command(
            "doctor",
            "Diagnose and verify the current runtime setup.",
            CommandCategory::Config,
            CommandKind::Local,
            &[],
            false,
        ...
        builtin_command(
            "init",
            "Initialize or refresh project guidance files.",
            CommandCategory::Config,
            CommandKind::Prompt,
            &[],
            true,
        ...
        builtin_command(
            "reload-auth",
            "Reload credentials from auth.json for OpenAI-family providers.",
            CommandCategory::Config,
            CommandKind::Local,
            &[],
            false,
        ...
        builtin_command(
            "sandbox",
            "Inspect or configure sandbox compatibility state.",
            CommandCategory::Config,
            CommandKind::Local,
            &[],
            false,
        ...
        builtin_command(
            "terminal-setup",
            "Install or inspect terminal newline shortcut compatibility.",
            CommandCategory::Config,
            CommandKind::Local,
            &[],
            false,
        ...
        builtin_command(
            "update-config",
            "Update Claude Code settings, permissions, or hooks.",
            CommandCategory::Config,
            CommandKind::Prompt,
            &[],
            true,
        ...
        builtin_command(
            "batch",
            "Plan and coordinate a large parallel change.",
        ...
        builtin_command(
            "debug",
            "Debug the current session or parity issue.",
            CommandCategory::Advanced,
            CommandKind::Prompt,
            &[],
            true,
        ...
        builtin_command(
            "effort",
            "Inspect or set the reasoning effort level.",
            CommandCategory::Config,
            CommandKind::Local,
            &[],
            false,
        ...
        builtin_command(
            "security-review",
            "Review the pending changes for concrete security risks.",
            CommandCategory::Session,
            CommandKind::Prompt,
            &[],
            true,
        ...
        builtin_command(
            "rewind",
            "Rewind the current session to an earlier prompt.",
            CommandCategory::Session,
            CommandKind::Local,
            &[],
            false,
        ...
        builtin_command(
            "longtask",
            "Enter a wrapper REPL for continuous task execution.",
            CommandCategory::Tooling,
            CommandKind::Local,
            &[],
            false,
        ...
        builtin_command(
            "mobile",
            "Show mobile handoff links for Claude.",
            CommandCategory::Tooling,
            CommandKind::Local,
            &[],
            false,
        ...
        builtin_command(
            "desktop",
            "Show desktop handoff details for the current session.",
            CommandCategory::Tooling,
            CommandKind::Local,
            &["app"],
            false,
        ...
        builtin_command(
            "chrome",
            "Inspect Claude in Chrome links and default preference.",
            CommandCategory::Tooling,
            CommandKind::Local,
            &[],
            false,
        ...
        builtin_command(
            "pr-comments",
            "Fetch and summarize pull request comments.",
            CommandCategory::Tooling,
            CommandKind::Prompt,
            &[],
            true,
        ...
        builtin_command(
            "advisor",
            "Inspect or set the advisor model preference.",
            CommandCategory::Advanced,
            CommandKind::Local,
            &[],
            false,
